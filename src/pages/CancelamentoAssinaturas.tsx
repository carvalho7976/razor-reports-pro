...
import { Hash, BanknoteIcon, Star } from "lucide-react";
  ...
  const summaryCards: SummaryCard[] = [
    {
      ...
      type: "quantity",
      icon: <Star-off className="h-4 w-4" />,
      size: "compact",
      color: "blue",
    },
    {
  ...
  return (
    <AppLayout>
      <DataTable
        ...
        pageSize={15}
        showDateFilter={true}
        tableId="cancelamento_assinaturas"
      />
      <YouTubeModal
        open={aulaOpen}
