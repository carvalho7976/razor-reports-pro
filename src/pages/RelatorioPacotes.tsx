...
const initialData: Pacote[] = [
  ...
  },
  {
    ...
    valor: 270,
    desconto: 30,
    dataVenda: "15/02/2026",
    profissional: "Ana",
  },
  {
    id: 3,
    nome: "Pacote Corte 5x",
    ...
    valor: 200,
    desconto: 25,
    dataVenda: "10/03/2026",
    profissional: "Carlos",
  },
  {
    id: 4,
    nome: "Pacote Coloração 2x",
    cliente: "Ana Costa",
...
const buildCards = (filtered: Pacote[]): SummaryCard[] => [
  {
    ...
    type: "quantity",
    icon: <Package-open className="h-4 w-4" />,
    size: "compact",
    color: "blue",
  },
  {
    ...
    icon: <Badge-dollar-sign className="h-4 w-4" />,
    size: "wide",
    color: "green",
  },
  {
