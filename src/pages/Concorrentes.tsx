export default function ComparativoPrecos() {
  const rows = [
    ["1", "12x R$59", "12x R$152", "~R$85", "R$99"],
    ["2", "12x R$69", "12x R$138", "~R$130", "R$163"],
    ["3 a 6", "12x R$79", "12x R$163", "~R$210", "R$286"],
    ["7 a 12", "12x R$110", "12x R$221", "~R$310", "R$397"],
    ["13 a 20", "12x R$135", "12x R$270", "~R$420", "R$397+"],
  ];
      ...
      <div className="max-w-6xl">
        ...
        <div className="overflow-x-auto rounded-2xl border border-zinc-200 bg-white shadow-[0_14px_45px_rgba(0,0,0,0.06)]">
          <div className="min-w-[920px]">
            ...
            {/* ROWS */}
            {rows.map(([agendas, especial, frizzar, trinks, avec]) => (
              <div
                key={agendas}
              ...
              >
                ...
                {/* FRIZZAR ESPECIAL */}
                <div className="flex min-h-16 flex-col items-center justify-center bg-white px-5 text-base font-semibold text-red-500">
                  {especial}
                </div>
        ...
        <p className="mt-4 text-left text-sm text-zinc-400">Valores comparativos com base nas faixas de agendas.</p>
      </div>
    </section>
  );
}
