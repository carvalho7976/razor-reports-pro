  ...
  return (
    <AppLayout>
      <DataTable
        ...
        titleIcon={
          <button
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#ffffff]/10 text-primary text-xs font-medium hover:bg-[ededed]/20 transition-colors"
            title="Assistir aula"
          >
