...
export default function Avaliacoes() {
  ...
  const summaryCards: SummaryCard[] = [
    { label: "NPS Geral", value: `${npsGeral}%`, icon: <Star className="h-4 w-4" /> },
  ];
  ...
  const columns: Column<Avaliacao>[] = [
    ...
    { key: "nota", label: "Nota", align: "center", render: v => (
      <span className="font-medium" style={{ color: v >= 9 ? "#00c5b4" : v >= 7 ? "#f59e0b" : "#ff2f2f" }}>{v}</span>
    )},
